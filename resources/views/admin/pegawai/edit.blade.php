                    ...
                    <form action="{{ route('pegawai.update', ['pegawai' => $pegawai->id]) }}" method="post"
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror"
                                placeholder="Input nip" value="{{ $pegawai->nip }}" autofocus>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                placeholder="Input nama" value="{{ $pegawai->nama }}">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="golongan"
                                ...
                                value="{{ $pegawai->golongan }}" placeholder="Input golongan">
                        ...
                        <x-adminlte-date-range name="tmt1" igroup-size="md" :config="$config"
                            value="{{ date('Y-m-d', strtotime($pegawai->tmt1)) }}" placeholder="Input tamatan 1">
                        ...
                        <x-adminlte-date-range name="tmt2" igroup-size="md" :config="$config"
                            value="{{ date('Y-m-d', strtotime($pegawai->tmt2)) }}" placeholder="Input tamatan 2">
                            <x-slot name="appendSlot">
                                <div class="input-group-text bg-dark">
                                    <i class="fas fa-calendar-day"></i>
                                </div>
                        ...
                        <x-adminlte-date-range name="masa_kerja" igroup-size="md" :config="$config"
                            value="{{ date('Y-m-d', strtotime($pegawai->masa_kerja)) }}" placeholder="Input masa kerja">
                            <x-slot name="appendSlot">
                                <div class="input-group-text bg-dark">
                                    <i class="fas fa-calendar-day"></i>
                                </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="nama_pelatihan"
                                ...
                                value="{{ $pegawai->nama_pelatihan }}" placeholder="Input pelatihan">
                        ...
                        <div class="form-group">
                            <input type="number" name="lama_kerja"
                                ...
                                step="1" placeholder="Input lama kerja" value="{{ $pegawai->lama_kerja }}" />
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="pendidikan"
                                ...
                                value="{{ $pegawai->pendidikan }}" placeholder="Input pendidikan">
                        ...
                        <x-adminlte-date-range name="tgl_lahir" igroup-size="md" :config="$config"
                            value="{{ $pegawai->tgl_lahir }}" placeholder="Input tanggal lahir">
                            <x-slot name="appendSlot">
                                <div class="input-group-text bg-dark">
                                    <i class="fas fa-calendar-day"></i>
                                </div>
                        ...
                        <div class="form-group">
                            @if ($pegawai->image == 'default.png' || $pegawai->image == 'default.webp' || $pegawai->image == 'default.jpg')
                                <img id="previewImg" src="{{ asset('storage/public/pegawai') }}/default.webp"
                                    width="300" height="300" class="img-thumbnail mb-5" alt="pegawai image">
                            @else
                                <img id="previewImg" src="{{ asset('storage/public/pegawai') }}/{{ $pegawai->image }}"
                                    width="300" height="300" class="img-thumbnail mb-5" alt="pegawai image">
                            @endif
