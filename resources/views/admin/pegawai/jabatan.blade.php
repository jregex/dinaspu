...
@php
    $heads = [['label' => 'No', 'width' => 3], 'Jabatan', ['label' => '#', 'no-export' => true, 'width' => 10]];
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('export.jabatan') }}" class="btn btn-info">Import csv</a>
                    {{-- <a href="{{ route('export.jabatan') }}" class="btn btn-info">Kosongkan data</a> --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <nobr>
                                        ...
                                        <form action="{{ route('jabatans.destroy', ['jabatan' => $item->id]) }}"
                ...
                <form method="post" id="formEdit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan" id="jabatanEdit" class="form-control" autofocus>
                        </div>
                    </div>
...
@endsection
@section('js')
    <script src="{{ asset('vendor/custom/custom-jabatan.js') }}"></script>
@stop
