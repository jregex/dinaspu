                    ...
                    <x-adminlte-datatable id="table1" :heads="$heads" head-theme="dark" :config="$config" striped
                        ...
                        @forelse ($categories as $item)
                            <tr>
                                ...
                                <td>
                                    <nobr>
                                        <a href="{{ route('galleries.index', ['category' => $item->id]) }}"
                                            class="btn btn-xs btn-default text-teal mx-1" title="Details">
                                        ...
                                        <form action="{{ route('gallery-categories.destroy', ['category' => $item->id]) }}"
...
@section('js')
    ...
    <script src="{{ asset('vendor/custom/custom-gallery-categories.js') }}"></script>
@stop
