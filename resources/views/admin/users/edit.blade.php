                    ...
                    <form action="{{ route('users.update', ['user' => $users->id]) }}" method="post"
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                value="{{ $users->nama }}" placeholder="{{ __('adminlte::adminlte.full_name') }}"
                                autofocus>
                        ...
                        <div class="input-group mb-3">
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                value="{{ $users->email }}" placeholder="{{ __('adminlte::adminlte.email') }}">
                        ...
                        <div class="form-group">
                            <img id="previewImg" src="{{ asset('storage/public/profile') }}/{{ $users->image }}"
                            ...
                            <div class="custom-file mb-2">
                                <input type="file" class="form-control @error('profile') is-invalid @enderror"
                                    id="profile" name="profile" lang="en" value="{{ $users->image }}">
                                @error('profile')
